/* ═══════════════════════════════════════════════════════════════
   ...
   ورقمُ الإصدار يُختم آليًّا عند كلِّ بناء — لا يُحرَّر بيدٍ ولا يُنسى.
   فكلُّ نشرةٍ تحمل ختمًا جديدًا يُبطل القديمَ كلَّه ويُنظّف مخازنَه.

   وخطوطُ المصحف في مخزنٍ اسمُه ثابتٌ لا يتبدّل مع الإصدارات،
   فرفعُ الرقم لا يُسقطها ولا يُعيد تنزيلَ ميغاباتٍ بلا حاجة.
   ═══════════════════════════════════════════════════════════════ */

const VERSION = 'zahim-2026-09-08-0756';   // يُختم آليًّا عند البناء — لا يُحرَّر بيد
